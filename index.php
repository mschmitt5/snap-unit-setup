...
<body>
    ...
    <p>You write the setup method so that you do not have to repeat as much code. It does the same thing before each unit test - in our example it wipes the database and inserts test data before each test.</p>
